...
def parse_arguments(argv):
    ...
    #                     help='Directory where to write event logs.', default='')
    # parser.add_argument('--models_base_dir', type=str,
    #                     help='Directory where to write trained models and checkpoints.', default='')
    parser.add_argument('--gpu_memory_fraction', type=float,
                        help='Upper bound on the amount of GPU memory that will be used by the process.', default=0.8)
    parser.add_argument('--pretrained_model', type=str,
                        help='Load a pretrained model before training starts.', default='4_2_512/model-20180402-114759.ckpt-275')
